...
SENSOR_DESCRIPTIONS: tuple[EverShelfSensorDescription, ...] = (
    ...
    EverShelfSensorDescription(
        ...
        extra_attr_keys=(
            ...
            "processing_score_phase",
            "processing_score_processed",
            "processing_score_total",
            "processing_score_progress",
            "processing_score_recovery_required",
            "processing_score_recovery_strategy",
            "processing_activation_outcome",
            "processing_activation_outcome_at",
            "processing_canonical_lock_available",
            "processing_canonical_oldest_pending_at",
            "processing_canonical_oldest_pending_age_seconds",
            "processing_canonical_oldest_retry_at",
            "processing_canonical_oldest_retry_age_seconds",
            "processing_canonical_oldest_due_at",
            "processing_canonical_oldest_due_age_seconds",
            "processing_canonical_oldest_in_progress_at",
            "processing_canonical_oldest_in_progress_age_seconds",
            "processing_canonical_earliest_lease_expires_at",
            "processing_canonical_next_due_at",
            "processing_canonical_stale_due_seconds",
            "processing_canonical_last_error_kind",
            "processing_canonical_last_error",
            "processing_canonical_last_error_at",
        ),
    ),
    EverShelfSensorDescription(
        ...
        extra_attr_keys=(
            ...
            "processing_canonical_open",
            "processing_canonical_active",
            "processing_canonical_pending",
            "processing_canonical_in_progress",
            "processing_canonical_retries",
            "processing_canonical_due",
            "processing_canonical_failed",
            "processing_canonical_exhausted",
            "processing_canonical_exhausted_pending",
            "processing_canonical_failed_24h",
            "processing_canonical_overdue_leases",
            "processing_canonical_stale_due",
            "processing_ontology_jobs",
            "processing_ontology_deferred",
            "processing_ontology_generation_intents",
            "processing_ontology_intents_pending",
            "processing_ontology_policy_deferred",
            "processing_ontology_intent_oldest_age_seconds",
            "processing_identity_coverage_gaps",
            "processing_coverage_gap_oldest_age_seconds",
            "processing_missing_recipe_observations",
            "processing_score_products",
            "processing_score_recipes",
            "processing_score_phase",
            "processing_score_processed",
            "processing_score_total",
            "processing_score_progress",
